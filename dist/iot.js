...
$vnode_7,
$vnode_8; 
 $vnode_1=[]; if(text){  $vnode_3=[$_create(0,0,(text))];;$$_style='';if(textWidth){;$$_style+='width:'+$n(textWidth)+'px';};$vnode_2=[$_create('div',{'class': 'paD pk', 'mx-click': $_viewId+'__bu()', 'style': $$_style,},$vnode_3 )]; $vnode_1.push(...$vnode_2); } $vnode_2=[$_create(0,0,'picker')];;$$_style='';if(color){;$$_style+='background:'+$n(color)+';';};if(!text){;$$_style+='width:100%';};$vnode_1.push($_create('div',{'class': 'paC pk', 'mx-click': $_viewId+'__bu()', 'style': $$_style,},$vnode_2 )); if(clear&&color){  $vnode_3=[$_create(0,0,'')];;$vnode_2=[$_create('i',{'class': 'p_ paR', 'mx-click': $_viewId+'__bv()', 'title': $n(i18n('_aA')),},$vnode_3 )]; $vnode_1.push(...$vnode_2); } $vnode_2=[]; if(renderUI){ $vnode_3=[];  $vnode_4=[]; for(let $q_key_sqykpwws=0,$q_a_cxbstmjk=shortcuts,$q_c_vebnxrhd=$q_a_cxbstmjk.length;$q_key_sqykpwws<$q_c_vebnxrhd;$q_key_sqykpwws++){let sc=$q_a_cxbstmjk[$q_key_sqykpwws];  ;$vnode_5=[$_create('li',{'class': 'paH', 'id': 'sc_'+$n(sc)+'_'+$n(id), 'style': 'background:#'+$n(sc), 'mx-click': $_viewId+'__br({color:\'#'+($eq(sc))+'\'})',})]; $vnode_4.push(...$vnode_5); };$vnode_3.push($_create('ul',{'class': 'paG pj', 'id': 'scs_'+$n(id),},$vnode_4 ));       if ($_quick_static_node_2) {
                                $vnode_8=[$_quick_static_node_2]; }else{;$vnode_8=[$_quick_static_node_2=$_create('stop',{'mxs': 'pv:_', 'offset': '0%', 'stop-color': '#000000', 'stop-opacity': '1',})]; } if ($_quick_static_node_3) {
                                $vnode_8.push($_quick_static_node_3); }else{;$vnode_8.push($_quick_static_node_3=$_create('stop',{'mxs': 'pv:a', 'offset': '100%', 'stop-color': '#CC9A81', 'stop-opacity': '0',})); };$vnode_7=[$_create('lineargradient',{'id': 'gb_'+$n(id), 'x1': '0%', 'y1': '100%', 'x2': '0%', 'y2': '0%',},$vnode_8 )];   if ($_quick_static_node_4) {
                                $vnode_8=[$_quick_static_node_4]; }else{;$vnode_8=[$_quick_static_node_4=$_create('stop',{'mxs': 'pv:b', 'offset': '0%', 'stop-color': '#FFFFFF', 'stop-opacity': '1',})]; } if ($_quick_static_node_3) {
                                $vnode_8.push($_quick_static_node_3); }else{;$vnode_8.push($_quick_static_node_3=$_create('stop',{'mxs': 'pv:a', 'offset': '100%', 'stop-color': '#CC9A81', 'stop-opacity': '0',})); };$vnode_7.push($_create('lineargradient',{'id': 'gw_'+$n(id), 'x1': '0%', 'y1': '100%', 'x2': '100%', 'y2': '100%',},$vnode_8 )); ;$vnode_6=[$_create('defs',0,$vnode_7 )];  ;$vnode_6.push($_create('rect',{'x': '0', 'y': '0', 'width': '100%', 'height': '100%', 'fill': 'url(#gw_'+$n(id)+')',}));  ;$vnode_6.push($_create('rect',{'x': '0', 'y': '0', 'width': '100%', 'height': '100%', 'fill': 'url(#gb_'+$n(id)+')',})); ;$vnode_5=[$_create('svg',$_quick_vnode_attr_static_1,$vnode_6 )];  ;$vnode_5.push($_create('div',{'class': 'paL', 'id': 'ci_'+$n(id),})); ;$vnode_4=[$_create('div',{'class': 'paK', 'id': 'cz_'+$n(id), 'mx-mousedown': $_viewId+'__bn()',},$vnode_5 )];      if ($_quick_static_node_5) {
                                $vnode_8=[$_quick_static_node_5]; }else{;$vnode_8=[$_quick_static_node_5=$_create('stop',{'mxs': 'pv:c', 'offset': '0%', 'stop-color': '#FF0000', 'stop-opacity': '1',})]; } if ($_quick_static_node_6) {
                                $vnode_8.push($_quick_static_node_6); }else{;$vnode_8.push($_quick_static_node_6=$_create('stop',{'mxs': 'pv:d', 'offset': '13%', 'stop-color': '#FF00FF', 'stop-opacity': '1',})); } if ($_quick_static_node_7) {
                                $vnode_8.push($_quick_static_node_7); }else{;$vnode_8.push($_quick_static_node_7=$_create('stop',{'mxs': 'pv:e', 'offset': '25%', 'stop-color': '#8000FF', 'stop-opacity': '1',})); } if ($_quick_static_node_8) {
                                $vnode_8.push($_quick_static_node_8); }else{;$vnode_8.push($_quick_static_node_8=$_create('stop',{'mxs': 'pv:f', 'offset': '38%', 'stop-color': '#0040FF', 'stop-opacity': '1',})); } if ($_quick_static_node_9) {
                                $vnode_8.push($_quick_static_node_9); }else{;$vnode_8.push($_quick_static_node_9=$_create('stop',{'mxs': 'pv:g', 'offset': '50%', 'stop-color': '#00FFFF', 'stop-opacity': '1',})); } if ($_quick_static_node_10) {
                                $vnode_8.push($_quick_static_node_10); }else{;$vnode_8.push($_quick_static_node_10=$_create('stop',{'mxs': 'pv:h', 'offset': '63%', 'stop-color': '#00FF40', 'stop-opacity': '1',})); } if ($_quick_static_node_11) {
                                $vnode_8.push($_quick_static_node_11); }else{;$vnode_8.push($_quick_static_node_11=$_create('stop',{'mxs': 'pv:i', 'offset': '75%', 'stop-color': '#0BED00', 'stop-opacity': '1',})); } if ($_quick_static_node_12) {
                                $vnode_8.push($_quick_static_node_12); }else{;$vnode_8.push($_quick_static_node_12=$_create('stop',{'mxs': 'pv:j', 'offset': '88%', 'stop-color': '#FFFF00', 'stop-opacity': '1',})); } if ($_quick_static_node_13) {
                                $vnode_8.push($_quick_static_node_13); }else{;$vnode_8.push($_quick_static_node_13=$_create('stop',{'mxs': 'pv:k', 'offset': '100%', 'stop-color': '#FF0000', 'stop-opacity': '1',})); };$vnode_7=[$_create('lineargradient',{'id': 'ghsv_'+$n(id), 'x1': '0%', 'y1': '100%', 'x2': '0%', 'y2': '0%',},$vnode_8 )]; ;$vnode_6=[$_create('defs',0,$vnode_7 )];  ;$vnode_6.push($_create('rect',{'x': '0', 'y': '0', 'width': '100%', 'height': '100%', 'fill': 'url(#ghsv_'+$n(id)+')',})); ;$vnode_5=[$_create('svg',$_quick_vnode_attr_static_1,$vnode_6 )];  ;$vnode_5.push($_create('div',{'class': 'paN', 'id': 'si_'+$n(id),})); ;$vnode_4.push($_create('div',{'class': 'paM', 'mx-mousedown': $_viewId+'__bo()',},$vnode_5 )); ;$vnode_3.push($_create('div',$_quick_vnode_attr_static_0,$vnode_4 )); if(alpha){    ;$vnode_6=[$_create('div',{'class': 'paT', 'id': 'ai_'+$n(id),})]; ;$vnode_5=[$_create('div',{'class': 'paS ph', 'id': 'at_'+$n(id), 'mx-mousedown': $_viewId+'__bp()',},$vnode_6 )]; ;$vnode_4=[$_create('div',$_quick_vnode_attr_static_14,$vnode_5 )]; $vnode_3.push(...$vnode_4); }  ;$vnode_4=[$_create('span',{'class': 'paQ', 'id': 'bc_'+$n(id),})];  ;$vnode_4.push($_create('input',{'class': 'pu paP', 'readonly': true, 'id': 'v_'+$n(id), 'value': $n(current),},0,1));  $vnode_5=[$_create(0,0,'确定')];;$vnode_4.push($_create('button',{'mxs': 'pv:l', 'class': 'pn po', 'type': 'button', 'mx-click': $_viewId+'__bq();',},$vnode_5 )); ;$vnode_3.push($_create('div',$_quick_vnode_attr_static_15,$vnode_4 )); $vnode_2.push(...$vnode_3); };$vnode_1.push($_create('div',{'id': 'bd_'+$n(id), 'class': 'paE paF-'+$n(placement), 'style': $n(align)+':-1px',},$vnode_2 )); ;$$_class='paA';if(disabled){;$$_class+=' paU';};$vnode_0.push($_create('div',{'mx-contextmenu': $_viewId+'__B()', 'id': 'root_'+$n(id), 'class': $$_class,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    ...
    init(data) {
        ...
        index_2.default["__bd"]();
        this.on('destroy', () => {
            index_2.default['__av'](this);
            index_2.default['__be']();
        });
        this.assign(data);
    },
    assign(data) {
    ...
    '__bm'(hex) {
        ...
        me['__bk'] = ('0' + a.toString(16)).slice(-2);
        me['__bj'](hsv);
        if (me['__bf']) {
            me['__bl'](a);
        }
...
$vnode_2,
$text; 
  $vnode_2=[$_create(0,0,(title))];;$vnode_1=[$_create('h5',0,$vnode_2 )]; ;$vnode_0.push($_create('div',$_quick_vnode_attr_static_0,$vnode_1 ));  $vnode_1=[$_create(0,0,(body))];;$vnode_0.push($_create('div',$_quick_vnode_attr_static_1,$vnode_1 ));   $vnode_2=[$_create(0,0,(i18n('_aD')))];;$vnode_1=[$_create('button',{'type': 'button', 'mx-click': $_viewId+'__bB()', 'class': 'pn pe',},$vnode_2 )];  $vnode_2=[$_create(0,0,(i18n('_aC')))];;$vnode_1.push($_create('button',{'type': 'button', 'mx-click': $_viewId+'__bq()', 'class': 'pn po pa pe',},$vnode_2 )); ;$vnode_0.push($_create('div',$_quick_vnode_attr_static_2,$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(extra) {
        let me = this;
        me['__bw'] = extra.dialog;
...
$text,
$vnode_4; 
 ;$$_class='paY';if(!removeClass){;$$_class+=' pb_';};$vnode_0.push($_create('div',{'style': 'z-index:'+$n(zIndex-1), 'id': 'mask_'+$n(id), 'class': $$_class,}));    ;$vnode_2=[$_create('input',{'id': 'focus_'+$n(id), 'class': 'pba',},0,1)];  $vnode_3=[$_create(0,0,'')];;$vnode_2.push($_create('span',{'class': 'p_ paX '+$n( closable ? '' : 'pi'), 'mx-click': $_viewId+'__bE()',},$vnode_3 ));   if ($_quick_static_node_0) {
                                $vnode_3=[$_quick_static_node_0]; }else{ ;$vnode_4=[$_create('span',{'class': 'pt',})]; ;$vnode_3=[$_quick_static_node_0=$_create('div',{'mxs': 'py:_', 'class': 'ps pbb',},$vnode_4 )]; };$vnode_2.push($_create('div',{'class': 'paW pbd', 'id': 'cnt_'+$n(id),},$vnode_3 )); ;$$_class='paV';if(!removeClass){;$$_class+=' pbf';};$vnode_1=[$_create('div',{'id': 'body_'+$n(id), 'style': 'left:'+$n(left)+'px;top:'+$n(top)+'px;width:'+$n(width)+'px;', 'class': $$_class,},$vnode_2 )]; ;$vnode_0.push($_create('div',{'class': 'pbe', 'style': 'z-index:'+$n(zIndex)+';',},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(extra) {
        let me = this;
...
exports.default = {
    ...
    '__bH'(e) {
        ...
        if (info) {
            ...
            for (fn of DragMoveEvent) {
                document.removeEventListener(fn, me['__bJ']);
            }
            for (fn of DragEndEvent) {
                document.removeEventListener(fn, me['__bK']);
            }
            for (fn of DragPreventEvent) {
                document.removeEventListener(fn, DragPrevent);
            }
            window.removeEventListener('blur', me['__bK']);
    ...
    '__x'(e, moveCallback, endCallback) {
        ...
        if (e) {
            ...
            let fn;
            for (fn of DragMoveEvent) {
                document.addEventListener(fn, me['__bJ']);
            }
            for (fn of DragEndEvent) {
                document.addEventListener(fn, me['__bK']);
            }
            for (fn of DragPreventEvent) {
            ...
            window.addEventListener('blur', me['__bK']);
        }
    },
    '__J'(x, y) {
        let node = null;
        if (document.elementFromPoint) {
            if (!DragPrevent['__bO'] && IsW3C) {
                DragPrevent['__bO'] = true;
                DragPrevent['__bP'] = document.elementFromPoint(-1, -1) !== null;
            }
            if (DragPrevent['__bP']) {
...
$vnode_7; 
 $vnode_1=[];   $vnode_3=[$_create(0,0,(selectedText))];;$$_class='pbm';if(selected===''||selected==emptyText){;$$_class+=' pbn';};$vnode_2=[$_create('span',{'class': $$_class,},$vnode_3 )];  if ($_quick_static_node_0) {
                                $vnode_2.push($_quick_static_node_0); }else{$vnode_3=[$_create(0,0,'')];;$vnode_2.push($_quick_static_node_0=$_create('span',{'mxs': 'pz:_', 'class': 'p_ pbk',},$vnode_3 )); };$vnode_1.push($_create('div',{'class': 'pbi', 'mx-click': $_viewId+'__bu()', 'title': $n(selectedText),},$vnode_2 )); if(rList){   $vnode_4=[]; for(let $q_key_yjrlfaks=0,$q_a_ltzugzxp=list,$q_c_pymkyj=$q_a_ltzugzxp.length;$q_key_yjrlfaks<$q_c_pymkyj;$q_key_yjrlfaks++){let item=$q_a_ltzugzxp[$q_key_yjrlfaks]; $vnode_5=[]; let text=item,value=item;;if(textKey&&valueKey){ $text='';text=item[textKey];$text+=' ';value=item[valueKey];}let equal=(value+'')===(selected+'');;  $vnode_7=[$_create(0,0,(text))];;$$_class='pbr pm';if(equal){;$$_class+=' pbs';};$vnode_6=[$_create('span',{'mx-click': $_viewId+'__bR({item:\''+$i($_ref,item)+'\'})', 'class': $$_class,},$vnode_7 )]; ;$vnode_5.push($_create('li',{'title': $n(text), 'active': ($_temp=(equal))!=null&&$_temp, 'class': 'pbq',},$vnode_6 )); $vnode_4.push(...$vnode_5); };$vnode_3=[$_create('ul',{'class': 'pbp', 'id': 'list_'+$n(id),},$vnode_4 )]; ;$vnode_2=[$_create('div',$_quick_vnode_attr_static_1,$vnode_3 )]; $vnode_1.push(...$vnode_2); };$$_class='pbh';if(disabled){;$$_class+=' pbj';};$vnode_0.push($_create('div',{'id': 'dd_'+$n(id), 'class': $$_class,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        index_1.default["__bd"]();
        this.on('destroy', () => {
            index_1.default['__av'](this);
            index_1.default['__be']();
        });
        this.assign(data);
    },
    assign(data) {
...
$vnode_2,
$text; 
  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.h=='flex-start'){;$$_class+=' pbv';};$vnode_1=[$_create('li',{'title': $n(i18n('_aE')), 'mx-click': $_viewId+'__au({type:\'h\',v:\'flex-start\'})', 'class': $$_class,},$vnode_2 )];  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.h=='center'){;$$_class+=' pbv';};$vnode_1.push($_create('li',{'title': $n(i18n('_aF')), 'mx-click': $_viewId+'__au({type:\'h\',v:\'center\'})', 'class': $$_class,},$vnode_2 ));  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.h=='flex-end'){;$$_class+=' pbv';};$vnode_1.push($_create('li',{'title': $n(i18n('_aG')), 'mx-click': $_viewId+'__au({type:\'h\',v:\'flex-end\'})', 'class': $$_class,},$vnode_2 ));  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.v=='flex-start'){;$$_class+=' pbv';};$vnode_1.push($_create('li',{'title': $n(i18n('_aH')), 'mx-click': $_viewId+'__au({type:\'v\',v:\'flex-start\'})', 'class': $$_class,},$vnode_2 ));  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.v=='center'){;$$_class+=' pbv';};$vnode_1.push($_create('li',{'title': $n(i18n('_aI')), 'mx-click': $_viewId+'__au({type:\'v\',v:\'center\'})', 'class': $$_class,},$vnode_2 ));  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.v=='flex-end'){;$$_class+=' pbv';};$vnode_1.push($_create('li',{'title': $n(i18n('_aJ')), 'mx-click': $_viewId+'__au({type:\'v\',v:\'flex-end\'})', 'class': $$_class,},$vnode_2 )); ;$$_class='pk pbt';if(disabled){;$$_class+=' pbw';};$vnode_0.push($_create('ul',{'class': $$_class,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
    assign(data) {
        this['__bS'] = data.value;
        this.set({
            value: data.value,
...
$vnode_2,
$text; 
  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.bold){;$$_class+=' pbv';};$vnode_1=[$_create('li',{'title': $n(i18n('_aK')), 'mx-click': $_viewId+'__au({key:\'bold\'})', 'class': $$_class,},$vnode_2 )];  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.italic){;$$_class+=' pbv';};$vnode_1.push($_create('li',{'title': $n(i18n('_aL')), 'mx-click': $_viewId+'__au({key:\'italic\'})', 'class': $$_class,},$vnode_2 ));  $vnode_2=[$_create(0,0,'')];;$$_class='pd pbu px';if(value.underline){;$$_class+=' pbv';};$vnode_1.push($_create('li',{'title': $n(i18n('_aM')), 'mx-click': $_viewId+'__au({key:\'underline\'})', 'class': $$_class,},$vnode_2 )); ;$$_class='pk pbt';if(disabled){;$$_class+=' pbw';};$vnode_0.push($_create('ul',{'class': $$_class,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
...
$vnode_5,
$text; 
  $vnode_2=[]; for(let $q_key_mqsevj=0,$q_a_apkdovdxyw=list,$q_c_xkqjkovs=$q_a_apkdovdxyw.length;$q_key_mqsevj<$q_c_xkqjkovs;$q_key_mqsevj++){let one=$q_a_apkdovdxyw[$q_key_mqsevj]; $vnode_3=[]; if(one.spliter){  if ($_quick_static_node_1) {
                                $vnode_4=[$_quick_static_node_1]; }else{;$vnode_4=[$_quick_static_node_1=$_create('li',{'mxs': 'pC:_', 'class': 'pbB',})]; }$vnode_3.push(...$vnode_4); }else{  $vnode_5=[$_create(0,0,(one[textKey]))];;$$_class='pm pbz ';if(disabled[one.id]){;$$_class+=' pbC';};$vnode_4=[$_create('li',{'mx-mouseover': $_viewId+'__c_({d:'+$n(disabled[one.id]||0)+'})', 'mx-mouseout': $_viewId+'__c_({d:'+$n(disabled[one.id]||0)+'});', 'mx-click': $_viewId+'__bR({item:\''+$i($_ref,one)+'\',d:'+$n(disabled[one.id]||0)+'})', 'title': $n(one[textKey]), 'class': $$_class,},$vnode_5 )]; $vnode_3.push(...$vnode_4); }$vnode_2.push(...$vnode_3); };$vnode_1=[$_create('ul',$_quick_vnode_attr_static_0,$vnode_2 )]; ;$vnode_0.push($_create('div',{'style': 'width:'+$n(width)+'px;position:absolute;left:-10000px;top:-10000px', 'class': 'pbx', 'id': 'cnt_'+$n(id), 'mx-contextmenu': $_viewId+'__B()',},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(extra) {
        let me = this;
        me.assign(extra);
...
let Watcher = (e) => {
    for (let i = Instances.length; i--;) {
        ...
        if (info['__ca']) {
            ...
            let view = info['__cb'];
            if (e.type == 'resize' || !view['__bs'](e.target)) {
                view['__z']();
            }
        }
    }
...
let $_temp,$vnode_0=[],$_empty_arr=[],
{
	...
	disabled,}=$$,
$$_class; 
 ;$vnode_0.push($_create('input',{'class': 'pbD', 'id': 'ipt_'+$n(id), 'mx-focusin': $_viewId+'__cu()', 'mx-focusout': $_viewId+'__cw()', 'mx-change': $_viewId+'__ct()', 'mx-keydown': $_viewId+'__cB()', 'disabled': (disabled), 'autocomplete': 'off', 'mx-input': $_viewId+'__cC()',},0,1));  ;$$_class='pbF pbG pk';if(disabled){;$$_class+=' pbH';};$vnode_0.push($_create('span',{'mx-click': $_viewId+'__cp({i:1})', 'mx-mousedown': $_viewId+'__cA({i:1})', 'mx-contextmenu': $_viewId+'__B()', 'class': $$_class,}));  ;$$_class='pbE pbG pk';if(disabled){;$$_class+=' pbH';};$vnode_0.push($_create('span',{'mx-click': $_viewId+'__cp()', 'mx-mousedown': $_viewId+'__cA()', 'mx-contextmenu': $_viewId+'__B()', 'class': $$_class,}));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(extra) {
        let me = this;
        me.assign(extra);
    ...
    assign(ops) {
        ...
        me['__cc'] = v;
        me['__ce'] = +ops.step || 1;
        me['__cf'] = (ops.empty + '') == 'true';
        me['__cg'] = (ops.format + '') == 'true';
        me['__cd'] = me.root.hasAttribute('disabled');
        me['__ch'] = magix_1.default.has(ops, 'max') ? +ops.max : Number.MAX_VALUE;
        me['__ci'] = magix_1.default.has(ops, 'min') ? +ops.min : -Number.MAX_VALUE;
        me['__cj'] = +ops.ratio || 10;
        me['__ck'] = ops.fixed || 0;
        return diff || preDis != me['__cd'];
    },
    render() {
        let me = this;
        me.digest({
    ...
    '__cl'() {
        ...
        let v = me['__cc'];
        if (v !== '') {
            v = me['__cm'](v); //.toFixed(me['@{tail.length}']);
            if (me['__cg']) {
                v = v.toFixed(me['__ck']);
            }
        }
        me['__cn'] = magix_1.node('ipt_' + me.id);
        me['__cn'].value = v;
    },
    '__cm'(v) {
        let me = this;
    ...
    '__cs'() {
        ...
        if (!magix_1.default.has(me, '__cr')) {
            me['__cr'] = me['__cc'];
        }
    },
    '__ct<change>'(e) {
    ...
    '__cA<mousedown>'(e) {
        ...
        if (!me['__cd']) {
            ...
            me['__cs']();
            let i = e.params.i;
            me['__cy'] = setTimeout(me.wrapAsync(() => {
                me['__cz'] = setInterval(me.wrapAsync(() => {
                    me['__cx'] = true;
                    me['__cp'](i);
                    me['__cq']();
                }), 50);
    ...
    '__cB<keydown>'(e) {
        if (e.keyCode == 38 || e.keyCode == 40) {
            ...
            if (!me['__cd']) {
                ...
                me['__cp'](e.keyCode == 38, e.shiftKey);
            }
        }
    },
    '__B<contextmenu>'(e) {
    ...
    '__cC<input>'(e) {
        e.stopPropagation();
        let target = e.eventTarget;
        this['__co'](target.value, true);
    },
    '$doc<mouseup>'() {
        let me = this;
        clearTimeout(me['__cy']);
        clearInterval(me['__cz']);
        delete me['__cv'];
        setTimeout(me.wrapAsync(() => {
            delete me['__cx'];
        }), 0);
...
$vnode_4,
$text; 
 $vnode_1=[]; if(src){   $vnode_4=[$_create(0,0,'')];;$vnode_3=[$_create('i',{'class': 'p_ pbQ', 'mx-click': ((!disabled))&&$_viewId+'__cF()', 'title': $n(i18n('_aN')),},$vnode_4 )]; ;$vnode_2=[$_create('div',{'class': 'pbM', 'style': 'background-image:url(\''+$n(src)+'\')',},$vnode_3 )]; $vnode_1.push(...$vnode_2); }else{  $vnode_3=[$_create(0,0,(i18n('_aO')))];;$vnode_2=[$_create('div',$_quick_vnode_attr_static_0,$vnode_3 )]; $vnode_1.push(...$vnode_2); };$$_class='pbI ph';if(disabled){;$$_class+=' pbR';};$vnode_0.push($_create('div',{'mx-click': ((!disabled))&&$_viewId+'__cE()', 'class': $$_class,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    mixins: [index_1.default],
    init(data) {
        this.assign(data);
...
let $_quick_vnode_attr_static_3={'class': 'pj pbS',};
let $_quick_vnode_attr_static_4={'class': 'pc pbN pm',};
/*
    author:xinglie.lkf@alibaba-inc.com
*/
...
$$_class,
$vnode_5; 
  $vnode_2=[$_create(0,0,(i18n('_aQ')))];;$vnode_1=[$_create('h5',0,$vnode_2 )]; ;$vnode_0.push($_create('div',$_quick_vnode_attr_static_0,$vnode_1 ));  $vnode_1=[]; if(error){  $vnode_3=[$_create(0,0,(error.msg))];;$vnode_2=[$_create('div',$_quick_vnode_attr_static_2,$vnode_3 )]; $vnode_1.push(...$vnode_2); }else{ $vnode_2=[];  $vnode_3=[]; for(let ci=0,$q_a_ywbwhpe=list,$q_c_tddkrnv=$q_a_ywbwhpe.length;ci<$q_c_tddkrnv;ci++){let category=$q_a_ywbwhpe[ci];  $vnode_5=[$_create(0,0,(category.title))];;$$_class='pbT';if(ci==cIndex){;$$_class+=' pbU';};$vnode_4=[$_create('div',{'mx-click': ((ci!=cIndex))&&$_viewId+'__cI({to:'+$n(ci)+'})', 'class': $$_class,},$vnode_5 )]; $vnode_3.push(...$vnode_4); };$vnode_2.push($_create('div',$_quick_vnode_attr_static_3,$vnode_3 )); for(let $q_key_gggpdab=0,$q_a_bqtkrd=list[cIndex].list,$q_c_rzwcudobi=$q_a_bqtkrd.length;$q_key_gggpdab<$q_c_rzwcudobi;$q_key_gggpdab++){let p=$q_a_bqtkrd[$q_key_gggpdab];    ;$vnode_5=[$_create('div',{'class': 'pbM', 'style': 'background-image:url(\''+$n(p.src)+'\')',})]; ;$vnode_4=[$_create('div',{'class': 'pbL', 'mx-click': $_viewId+'__cH({src:\''+($eq(p.src))+'\'})',},$vnode_5 )];  $vnode_5=[$_create(0,0,(p.title))];;$vnode_4.push($_create('div',$_quick_vnode_attr_static_4,$vnode_5 )); ;$vnode_3=[$_create('div',{'class': 'pd', 'title': $n(p.title),},$vnode_4 )]; $vnode_2.push(...$vnode_3); }$vnode_1.push(...$vnode_2); };$vnode_0.push($_create('div',$_quick_vnode_attr_static_1,$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        let me = this;
        me['__bw'] = data.dialog;
...
magix_1.default.applyStyle("pn",".pbV{opacity:0;background:#fff;position:fixed;left:0;right:0;top:0;bottom:0;z-index:10000}");
const Body = document.body;
exports.default = {
    '__y'(e) {
        let styles = getComputedStyle(e);
        this['__ay'](styles.cursor);
    },
    '__ay'(cursor) {
        let n = magix_1.node(CursorId);
        if (!n) {
            document.body.insertAdjacentHTML('beforeend', `<div class="pbV" id="${CursorId}"/>`);
...
Object.defineProperty(exports, "__esModule", { value: true });
const magix_1 = require("magix");
magix_1.default.applyStyle("po",".pbW{background:#fa742b;position:absolute;opacity:.6;left:-1000px;top:-1000px;width:30px;height:30px;text-align:center;line-height:30px;color:#fff;border-radius:2px;z-index:5000;pointer-events:none}");
let DEId = magix_1.default.guid('de_');
exports.default = {
    '__aJ'(html) {
        let n = magix_1.node(DEId);
        if (!n) {
            document.body.insertAdjacentHTML('beforeend', `<div class="pbW px" id="${DEId}"/>`);
            n = magix_1.node(DEId);
        }
        n.innerHTML = html;
    },
...
*/
const magix_1 = require("magix");
magix_1.default.applyStyle("pp",".pbX{position:absolute;border:1px dashed #fa742b;display:none;pointer-events:none}");
let SId = magix_1.default.guid('set_');
exports.default = {
    '__H'() {
        let n = magix_1.node(SId);
        if (!n) {
            document.body.insertAdjacentHTML('beforeend', `<div id="${SId}" class="pbX"></div>`);
        }
    },
    '__aJ'(left, top, width, height) {
...
let FX = function (interval, alg) {
    ...
    if (!me['__cJ'] || alg) {
        alg = alg || DALG;
        me['__cJ'] = (from, to) => {
            return (from + (to - from) * alg(me['__cK'] / me['__cL']));
        };
    }
    me['__cM'] = [];
    me['__cN'] = interval;
...
magix_1.default.mix(FX.prototype, {
    ...
    '__cR'() {
        let me = this;
        let item = me['__cM'].shift();
        if (item) {
            me['__cL'] = item['__cO'];
            me['__cT'] = item['__cP'];
            me['__cU'] = Now();
            if (!me['__cQ']) {
                index_1.default['__cV'](me['__cN'], me['__cQ'] = end => {
                    me['__cK'] = Date.now() - me['__cU'];
                    if (me['__cK'] > me['__cL']) {
                        me['__cK'] = me['__cL'];
                        end = 1;
                    }
...
exports.default = {
    '__cZ'(interval, alg) {
        ...
        this.capture(magix_1.default.guid('__cY'), fx);
        return fx;
    }
};
...
exports.default = {
    ...
    '__bb'(oPoint, scale, oTransformedRect, baseIndex) {
        let scaledRect = this['__du']({
            x: oPoint.x,
            y: oPoint.y,
            width: oPoint.width,
        ...
        let transformedRotateRect = this['__aB'](scaledRect, oPoint.rotate);
        // 计算到平移后的新坐标
...
let $_quick_vnode_attr_static_0={'class': 'pcg pk pj',};
...
magix_1.default.applyStyle("ps",".pcf{background:hsla(0,0%,100%,.93);position:absolute;box-shadow:0 2px 4px 0 rgba(0,0,0,.3)}.pcg{font-size:12px;height:18px;line-height:18px;background:#fa742b;color:#fff}.pch{padding:0 5px;cursor:move;width:calc(100% - 36px)}.pci{width:16px;height:14px;margin:0 1px;font-size:11px;cursor:pointer;display:inline-flex;justify-content:center;align-items:center;border-radius:2px}.pci:hover{background:#e64e30}.pcj{overflow:hidden;transition:height .25s}.pck{transition:none}.pcl{width:calc(100% - 2px);overflow:auto;float:left}.pcm{width:2px;float:right;cursor:ew-resize}.pcn,.pcm{background:#fafafa}.pcn{height:2px;cursor:ns-resize}.pco{scroll-behavior:smooth}.pco::-webkit-scrollbar,.pco::-webkit-scrollbar-corner{height:2px;width:2px;background:#fafafa}");
let MinWidth = 100;
let ZIndex = 300;
let Panels = [];
let PanelsManager = {
...
$text,
$$_class; 
    $vnode_4=[$_create(0,1,(icon))];;$vnode_3=[$_create('i',$_quick_vnode_attr_static_1,$vnode_4 )]; $vnode_3.push($_create(0,0,(i18n(title))));;$vnode_2=[$_create('div',{'class': 'pch pd', 'title': $n(i18n('__aR')), 'mx-mousedown': $_viewId+'__dn()',},$vnode_3 )];   $vnode_4=[$_create(0,0,'')];;$$_class='px pci';if(shrink){;$$_class+=' pA';};$vnode_3=[$_create('i',{'mx-click': $_viewId+'__dp()', 'title': $n(i18n(shrink?'__aY':'__aZ',title)), 'class': $$_class,},$vnode_4 )];  $vnode_4=[$_create(0,0,'')];;$vnode_3.push($_create('i',{'class': 'px pci', 'mx-click': $_viewId+'__bE()', 'title': $n(i18n('_t',title)),},$vnode_4 )); ;$vnode_2.push($_create('div',$_quick_vnode_attr_static_2,$vnode_3 )); ;$vnode_1=[$_create('div',$_quick_vnode_attr_static_0,$vnode_2 )];  $vnode_2=[];  ;$vnode_2.push($_create('div',{'style': 'width:'+$n(resizeX?'calc(100% - 2px)':'100%'), 'class': 'pcl pl pco pb', 'mx-view': $n(view),})); if(!resizeX){  ;$vnode_3=[$_create('div',{'class': 'pcm pk pb', 'title': $n(i18n('__aS')), 'mx-mousedown': $_viewId+'__bc({w:1})',})]; $vnode_2.push(...$vnode_3); };$vnode_1.push($_create('div',{'class': 'pcj', 'id': 'c_'+$n(id), 'style': 'height:'+$n((shrink?0:fixedSize?`${height}px`:`calc(100vh - ${height}px)`)),},$vnode_2 ));  ;$$_class='pcn pk';if(shrink||!resizeY){;$$_class+=' pi';};$vnode_1.push($_create('div',{'title': $n(i18n('__aT')), 'mx-mousedown': $_viewId+'__bc({h:1})', 'class': $$_class,})); ;$$_style='width:'+$n(width)+'px;';if(left!=null){;$$_style+='left:'+$n(left);}else{;$$_style+='right:'+$n(right);};$$_style+='px;';if(top!=null){;$$_style+='top:'+$n(top)+'px';}else{;$$_style+='bottom:'+$n(bottom)+'px';};$$_style+=';z-index:'+$n(zIndex)+';';$vnode_0.push($_create('div',{'class': 'pcf', 'id': 'p_'+$n(id), 'mx-mousedown': $_viewId+'__do()', 'style': $$_style,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    mixins: [index_1.default],
    init(data) {
        PanelsManager["__aw"](this);
        this.on('destroy', () => {
            PanelsManager["__av"](this);
        });
        this['__dm'] = data.close;
        this.set({
            icon: data.icon,
            title: data.title,
            width: data.width,
...
let $_quick_vnode_attr_static_0={'class': 'pbY pk',};
let $_quick_vnode_attr_static_1={'class': 'px pca',};
...
magix_1.default.applyStyle("pq",".pbY{padding:5px 2px}.pbZ{display:flex;align-items:center;padding:0 2px;color:#333;height:22px;line-height:22px;cursor:pointer;margin:1px 0}.pbZ:hover{background:#f0f0f0}.pc_,.pc_:hover{background:#fcb58f}.pca{margin:0 4px 0 2px;font-size:12px}.pcb{border:2px solid #fa742b}");
let RId = magix_1.default.guid('rp_');
let RectPole = {
    '__H'() {
        let n = magix_1.node(RId);
        if (!n) {
            document.body.insertAdjacentHTML("beforeend", `<div class="pg pcb" id="${RId}"></div>`);
        }
    },
    '__y'(element) {
        let ns = magix_1.node(RId).style;
        let { props } = element;
        let pos = converter_1.default["__da"](props);
        ns.left = pos.x + 'px';
        ns.top = pos.y + 'px';
...
$vnode_3,
$vnode_4; 
 $vnode_1=[]; for(let i=elements.length;i--;){ let e=elements[i];;  $vnode_4=[$_create(0,1,(e.ctrl.icon))];;$vnode_3=[$_create('i',$_quick_vnode_attr_static_1,$vnode_4 )];  $vnode_4=[$_create(0,0,(i18n(e.ctrl.title)))];;$vnode_3.push($_create('div',$_quick_vnode_attr_static_2,$vnode_4 )); ;$$_class='pbZ';if(selectedMap[e.id]){;$$_class+=' pc_';};$vnode_2=[$_create('div',{'mx-mouseover': $_viewId+'__db({element:\''+$i($_ref,e)+'\'})', 'mx-mouseout': $_viewId+'__dc()', 'mx-click': $_viewId+'__dd({element:\''+$i($_ref,e)+'\'})', 'class': $$_class,},$vnode_3 )]; $vnode_1.push(...$vnode_2); };$vnode_0.push($_create('div',$_quick_vnode_attr_static_0,$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init() {
        RectPole["__H"]();
    ...
    '__dd<click>'(e) {
        let { element } = e.params;
        stage_elements_1.default["__ax"](e, element);
    }
});
...
/*
    ...
    loader: cmd_es
 */
define("panels/overview/index",["magix","../../gallery/mx-dragdrop/index"],(require,exports,module)=>{
/*magix_1,index_1*/
...
const magix_1 = require("magix");
const index_1 = require("../../gallery/mx-dragdrop/index");
magix_1.default.applyStyle("pr",".pcc{background:#edeef3;position:relative;overflow:hidden;box-shadow:inset 1px 1px 6px 2px #dadada}.pcd{position:absolute;border:1px solid #fa742b;cursor:move;background:hsla(0,0%,100%,.13)}.pce{background:#fcb58f;position:absolute;border:1px dotted #fff}");
...
$vnode_3,
$text; 
  $vnode_2=[]; for(let $q_key_vgalweojrq=0,$q_a_dnjlwavc=elements,$q_c_rxklurlx=$q_a_dnjlwavc.length;$q_key_vgalweojrq<$q_c_rxklurlx;$q_key_vgalweojrq++){let {props:props}=$q_a_dnjlwavc[$q_key_vgalweojrq]; let ew=Math.max(props.width*ratio,1),eh=Math.max(props.height*ratio,1);; ;$vnode_3=[$_create('div',{'class': 'pce', 'style': 'left:'+$n(props.x*ratio)+'px;top:'+$n(props.y*ratio)+'px;width:'+$n(ew)+'px;height:'+$n(eh)+'px;transform:rotate('+$n(props.rotate)+'deg);',})]; $vnode_2.push(...$vnode_3); };$vnode_1=[$_create('div',{'style': 'position: relative;background:'+$n(page.background)+';width:'+$n(pageWidth)+'px;height:'+$n(pageHeight)+'px;margin:'+$n(canvasMargin),},$vnode_2 )];  ;$vnode_1.push($_create('div',{'class': 'pcd', 'style': 'left:'+$n(left)+'px;top:'+$n(top)+'px;width:'+$n(viewportWidth)+'px;height:'+$n(viewportHeight)+'px;', 'mx-mousedown': $_viewId+'__di()',})); ;$vnode_0.push($_create('div',{'class': 'pcc', 'style': 'width:'+$n(width)+'px;height:'+$n(height)+'px;margin:'+$n(centerMargin),},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init() {
        let updateOverview = this['__dg'].bind(this);
        magix_1.State.on('___', updateOverview);
        magix_1.State.on('__a', updateOverview);
        magix_1.State.on('__b', updateOverview);
        magix_1.State.on('__i', updateOverview);
        magix_1.State.on('__k', updateOverview);
        magix_1.State.on('__m', updateOverview);
        let stage = magix_1.node('stage');
    ...
    '__dg'() {
        let me = this;
        CancelIdle(me['__dh']);
        me['__dh'] = Idle(this.render.bind(this));
    },
    render() {
    ...
    '__di<mousedown>'(e) {
        let startX = this.get('left'), startY = this.get('top'), viewportWidth = this.get('viewportWidth'), viewportHeight = this.get('viewportHeight'), width = this.get('width'), height = this.get('height'), stage = magix_1.node('stage'), ratio = this.get('ratio');
        this['__x'](e, ex => {
...
/*
    ...
    loader: cmd_es
 */
define("panels/props/index",["magix","../../designer/props","../../designer/history","../../util/transform","gallery/mx-number/index","gallery/mx-color/index","gallery/mx-font/style","gallery/mx-font/align","gallery/mx-dropdown/index","gallery/mx-picture/index","./page"],(require,exports,module)=>{
...
let $_quick_static_node_5;
let $_quick_static_node_6;
let $_quick_vnode_attr_static_0={'class': 'pcp',};
let $_quick_vnode_attr_static_1={'class': 'pcq',};
let $_quick_vnode_attr_static_2={'class': 'pcr',};
let $_quick_vnode_attr_static_4={'class': 'pcw',};
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/*
    author:xinglie.lkf@alibaba-inc.com
...
magix_1.default.applyStyle("pt",".pcp{padding:4px;min-width:200px}.pcq{line-height:28px;display:flex;align-items:center}.pcr{width:80px;text-align:right}.pcs{height:1px;line-height:1px;margin:5px 0;background:rgba(0,0,0,.2);background:-webkit-gradient(linear,left top,right top,from(rgba(165,69,243,0)),color-stop(.5,rgba(125,118,132,.33)),to(rgba(165,69,243,0)))}.pct{width:140px}.pcu{height:90px}.pcv{align-items:flex-start}.pcw{display:flex;align-items:center;cursor:pointer}.pcx{visibility:hidden;position:absolute}.pcy{width:32px;height:16px;position:relative;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;display:inline-block;border-radius:22px;background:#ccc}.pcy:before{content:\"\";width:12px;height:12px;position:absolute;left:0;margin:2px;border-radius:50%;background:#fff;transition:all .25s}.pcx:checked+.pcy{background:#fa742b}.pcx:checked+.pcy:before{left:100%;margin-left:-14px}.pcx:disabled+.pcy{background:#e6e6e6;cursor:not-allowed}");
exports.default = magix_1.default.View.extend({
    tmpl: ($$, $_create,$_viewId,$n,$eu,$_ref,$i,$eq)=> { 
let $_temp,$vnode_0=[],$_empty_arr=[],
{
...
$$_mx_view,
$vnode_8; 
if(elements.length==1){ let e=elements[0];; $vnode_2=[];   $vnode_4=[$_create(0,0,(i18n('__b_')))];;$vnode_3=[$_create('span',$_quick_vnode_attr_static_2,$vnode_4 )];  $vnode_4=[$_create(0,0,(i18n(e.ctrl.title)))];;$vnode_3.push($_create('span',0,$vnode_4 )); ;$vnode_2.push($_create('li',$_quick_vnode_attr_static_1,$vnode_3 )); for(let $q_key_ukqdemzisn=0,$q_a_nytmhwnp=e.ctrl.props,$q_c_wuejalo=$q_a_nytmhwnp.length;$q_key_ukqdemzisn<$q_c_wuejalo;$q_key_ukqdemzisn++){let p=$q_a_nytmhwnp[$q_key_ukqdemzisn]; $vnode_3=[]; if(p.type==props['__aa']){  if ($_quick_static_node_3) {
                                $vnode_4=[$_quick_static_node_3]; }else{;$vnode_4=[$_quick_static_node_3=$_create('li',{'mxs': 'pK:_', 'class': 'pcs',})]; }$vnode_3.push(...$vnode_4); }else{ $vnode_4=[]; let data=e.props[p.key];;if(p.read){ data=p.read(data);;}if(!p.ifShow||p.ifShow(e.props)){  $vnode_6=[];  $vnode_7=[$_create(0,0,(i18n(p.tip)))];;$vnode_6.push($_create('span',$_quick_vnode_attr_static_2,$vnode_7 )); if(p.type==props['__Z']){  ;$$_mx_view='gallery/mx-number/index?value='+$i($_ref,data);if(($_temp=p.max)!=null){;$$_mx_view+='&max='+($eu($_temp));};if(($_temp=p.step)!=null){;$$_mx_view+='&step='+($eu($_temp));};if(($_temp=p.fixed)!=null){;$$_mx_view+='&fixed='+($eu($_temp));};if(($_temp=p.min)!=null){;$$_mx_view+='&min='+($eu($_temp));};$vnode_7=[$_create('div',{'mxv': 'elements', 'class': 'pct pu ph', 'disabled': ($_temp=(e.props.locked))!=null&&$_temp, 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'value\',element:\''+$i($_ref,e)+'\',write:\''+$i($_ref,p.write)+'\'})', 'mx-view': $$_mx_view,})]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__a_']){  ;$vnode_7=[$_create('div',{'mxv': 'elements', 'class': 'pct', 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'color\',element:\''+$i($_ref,e)+'\'})', 'mx-view': 'gallery/mx-color/index?clear='+($eu(p.clear))+'&color='+$i($_ref,data)+'&align=right&disabled='+($eu(e.props.locked))+'&alpha='+($eu(p.alpha)),})]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__ab']){   ;$vnode_8=[$_create('input',{'class': 'pcx', 'type': 'checkbox', 'checked': (e.props[p.key]), 'mx-change': $_viewId+'__ds({key:\''+($eq(p.key))+'\',native:\'checked\',element:\''+$i($_ref,e)+'\',refresh:\''+$i($_ref,p.refresh)+'\'})',},0,1)];  if ($_quick_static_node_5) {
                                $vnode_8.push($_quick_static_node_5); }else{;$vnode_8.push($_quick_static_node_5=$_create('i',{'mxs': 'pK:a', 'class': 'pcy',})); };$vnode_7=[$_create('label',$_quick_vnode_attr_static_4,$vnode_8 )]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__ae']){  ;$vnode_7=[$_create('textarea',{'class': 'pv pct pcu', 'disabled': (e.props.locked), 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',native:\'value\',element:\''+$i($_ref,e)+'\'})', 'value': $n(data),})]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__ac']){  ;$vnode_7=[$_create('div',{'mxv': 'elements', 'class': 'pct', 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'value\',element:\''+$i($_ref,e)+'\'})', 'mx-view': 'gallery/mx-font/style?disabled='+$i($_ref,e.props.locked)+'&value='+$i($_ref,data),})]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__ad']){  ;$vnode_7=[$_create('div',{'mxv': 'elements', 'class': 'pct', 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'value\',element:\''+$i($_ref,e)+'\'})', 'mx-view': 'gallery/mx-font/align?disabled='+$i($_ref,e.props.locked)+'&value='+$i($_ref,data),})]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__ag']){  ;$$_mx_view='gallery/mx-dropdown/index?';if(($_temp=e.props.locked)!=null){;$$_mx_view+='disabled='+$i($_ref,$_temp);};$$_mx_view+='&selected='+($eu(data))+'&list='+$i($_ref,p.items)+'&textKey=text&valueKey=value';$vnode_7=[$_create('div',{'mxv': 'elements', 'class': 'pct', 'mx-change': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'value\',element:\''+$i($_ref,e)+'\'})', 'mx-view': $$_mx_view,})]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__af']){  ;$vnode_7=[$_create('div',{'mxv': 'elements', 'class': 'pct', 'mx-change': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'src\',refresh:\''+$i($_ref,p.refresh)+'\',element:\''+$i($_ref,e)+'\',write:\''+$i($_ref,p.write)+'\'})', 'mx-view': 'gallery/mx-picture/index?src='+($eu(data))+'&disabled='+$i($_ref,e.props.locked),})]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__ah']){  $vnode_8=[$_create(0,0,(i18n('__bc')))];;$vnode_7=[$_create('button',{'class': 'pn po', 'disabled': (e.props.locked), 'mx-click': $_viewId+'__dt({key:\''+($eq(p.key))+'\',element:\''+$i($_ref,e)+'\'})',},$vnode_8 )]; $vnode_6.push(...$vnode_7); }else if(p.type==props['__ai']){  ;$vnode_7=[$_create('input',{'class': 'pu', 'disabled': (e.props.locked), 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',native:\'value\',element:\''+$i($_ref,e)+'\'})',},0,1)]; $vnode_6.push(...$vnode_7); };$$_class='pcq';if(p.dockTop){;$$_class+=' pcv';};$vnode_5=[$_create('li',{'class': $$_class,},$vnode_6 )]; $vnode_4.push(...$vnode_5); }$vnode_3.push(...$vnode_4); }$vnode_2.push(...$vnode_3); };$vnode_1=[$_create('ul',$_quick_vnode_attr_static_0,$vnode_2 )]; $vnode_0.push(...$vnode_1); }else{  if ($_quick_static_node_6) {
                                $vnode_1=[$_quick_static_node_6]; }else{;$vnode_1=[$_quick_static_node_6=$_create('div',{'mxs': 'pK:b', 'mx-view': 'panels/props/page',})]; }$vnode_0.push(...$vnode_1); } 
return $_create($_viewId, 0, $vnode_0);  } ,
    init() {
        let update = this['__dq'](this.render.bind(this), 100);
        magix_1.State.on('__l', update);
    ...
    '__ds<input,change>'(e) {
        ...
        if (use || native) {
            ...
            if (resetXY) {
                old = transform_1.default["__dr"](props, props.rotate);
            }
            ...
            props[key] = v;
            if (resetXY) {
                let n = transform_1.default["__dr"](props, props.rotate);
                props.x += old.x - n.x;
                props.y += old.y - n.y;
                refresh = true;
            }
    ...
    '__dt<click>'(e) {
        ...
        let props = element.props;
        let old = transform_1.default["__dr"](props, props.rotate);
        let img = new Image();
        img.onload = () => {
            ...
            this.render();
            magix_1.State.fire('__m');
            let n1 = magix_1.node(element.id);
            let vf = magix_1.Vframe.byNode(n1);
            if (vf) {
                vf.invoke('__aJ', [element]);
            }
            history_1.default["__t"]('__a' + key, 500);
...
$vnode_5,
$$_mx_view; 
 $vnode_1=[];   $vnode_3=[$_create(0,0,(i18n('__b_')))];;$vnode_2=[$_create('span',$_quick_vnode_attr_static_2,$vnode_3 )];  $vnode_3=[$_create(0,0,(i18n(ctrl.title)))];;$vnode_2.push($_create('span',0,$vnode_3 )); ;$vnode_1.push($_create('li',$_quick_vnode_attr_static_1,$vnode_2 )); for(let $q_key_juzpiufxo=0,$q_a_itlgcgp=ctrl.props,$q_c_nokwlotwm=$q_a_itlgcgp.length;$q_key_juzpiufxo<$q_c_nokwlotwm;$q_key_juzpiufxo++){let p=$q_a_itlgcgp[$q_key_juzpiufxo]; $vnode_2=[]; if(p.type==props['__aa']){  if ($_quick_static_node_3) {
                                $vnode_3=[$_quick_static_node_3]; }else{;$vnode_3=[$_quick_static_node_3=$_create('li',{'mxs': 'pL:_', 'class': 'pcs',})]; }$vnode_2.push(...$vnode_3); }else if(!p.ifShow||p.ifShow(page)){  $vnode_4=[];  $vnode_5=[$_create(0,0,(i18n(p.tip)))];;$vnode_4.push($_create('span',$_quick_vnode_attr_static_2,$vnode_5 )); if(p.type==props['__Z']){  ;$$_mx_view='gallery/mx-number/index?value='+$i($_ref,page[p.key]);if(($_temp=p.max)!=null){;$$_mx_view+='&max='+($eu($_temp));};$$_mx_view+='&step='+($eu(p.step));if(($_temp=p.fixed)!=null){;$$_mx_view+='&fixed='+($eu($_temp));};if(($_temp=p.min)!=null){;$$_mx_view+='&min='+($eu($_temp));};$vnode_5=[$_create('div',{'mxv': 'page,ctrl', 'class': 'pct pu ph', 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'value\'})', 'mx-view': $$_mx_view,})]; $vnode_4.push(...$vnode_5); }else if(p.type==props['__a_']){  ;$vnode_5=[$_create('div',{'mxv': 'page,ctrl', 'class': 'pct', 'mx-input': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'color\'})', 'mx-view': 'gallery/mx-color/index?clear='+($eu(p.clear))+'&color='+$i($_ref,page[p.key])+'&align=right&alpha='+($eu(p.alpha)),})]; $vnode_4.push(...$vnode_5); }else if(p.type==props['__af']){  ;$vnode_5=[$_create('div',{'class': 'pct', 'mx-change': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'src\',refresh:\''+$i($_ref,p.refresh)+'\',write:\''+$i($_ref,p.write)+'\'})', 'mx-view': 'gallery/mx-picture/index?src='+($eu(page[p.key])),})]; $vnode_4.push(...$vnode_5); }else if(p.type==props['__ag']){  ;$vnode_5=[$_create('div',{'mxv': 'ctrl', 'class': 'pct', 'mx-change': $_viewId+'__ds({key:\''+($eq(p.key))+'\',use:\'value\',refresh:\''+$i($_ref,p.refresh)+'\'})', 'mx-view': 'gallery/mx-dropdown/index?selected='+($eu(page[p.key]))+'&list='+$i($_ref,p.items)+'&textKey=text&valueKey=value',})]; $vnode_4.push(...$vnode_5); };$$_class='pcq';if(p.dockTop){;$$_class+=' pcv';};$vnode_3=[$_create('li',{'class': $$_class,},$vnode_4 )]; $vnode_2.push(...$vnode_3); }$vnode_1.push(...$vnode_2); };$vnode_0.push($_create('ul',$_quick_vnode_attr_static_0,$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init() {
        let update = this.render.bind(this);
        magix_1.State.on('___', update);
...
let props=element.props;; ;$vnode_0.push($_create('div',{'mxv': 'element,scale,onlyMove', 'class': 'pk', 'mx-view': $n(view)+'?props='+$i($_ref,props)+'&scale='+$i($_ref,scale)+'&onlyMove='+$i($_ref,onlyMove), 'id': 'entity_'+$n(id),})); let r=props.rotate%360;; $vnode_1=[]; if(!fullscreen&&!props.locked){ $vnode_2=[]; if(selected){ $vnode_3=[];  if ($_quick_static_node_0) {
                                $vnode_3.push($_quick_static_node_0); }else{;$vnode_3.push($_quick_static_node_0=$_create('div',{'mxs': 'pp:_', 'class': 'pas',})); }if(count==1){  ;$vnode_4=[$_create('div',{'class': 'paz pg', 'mx-mousedown': $_viewId+'__b_()', 'title': $n(i18n('_S')),})]; $text='';let height=(Math.min(20,props.height-3)-4);;$text+=' ';let width=(Math.min(20,props.width)-4);;$text+=' ';let size=Math.max(Math.min(width,height)-2,0);;$text+=' ';width=Math.min(width,props.width-size-6);$text+=' ';height=Math.min(height,props.height-size-6-3);$text+=' ';let top=(props.height-height-size+3)/2;; ;$$_style='height:'+$n(Math.max(height,0))+'px;top:'+$n(top)+'px;cursor:';if(r<=22.5||r>337.5||(r>157.5&&r<=202.5)){;$$_style+='ew';}else if(r<=67.5||(r>202.5&&r<=247.5)){;$$_style+='nwse';}else if(r<=112.5||(r>247.5&&r<=292.5)){;$$_style+='ns';}else if(r<=157.5||(r>292.5&&r<=337.5)){;$$_style+='nesw';};$$_style+='-resize';$vnode_4.push($_create('div',{'class': 'pg paw', 'title': $n(i18n('_T')), 'mx-mousedown': $_viewId+'__bc({key:\'rm\'})', 'style': $$_style,})); let left=(props.width-width-size)/2;; ;$$_style='width:'+$n(Math.max(width,0))+'px;left:'+$n(left)+'px;cursor:';if(r<=22.5||r>337.5||(r>157.5&&r<=202.5)){;$$_style+='ns';}else if(r<=67.5||(r>202.5&&r<=247.5)){;$$_style+='nesw';}else if(r<=112.5||(r>247.5&&r<=292.5)){;$$_style+='ew';}else if(r<=157.5||(r>292.5&&r<=337.5)){;$$_style+='nwse';};$$_style+='-resize';$vnode_4.push($_create('div',{'class': 'pg pax', 'title': $n(i18n('_U')), 'mx-mousedown': $_viewId+'__bc({key:\'mb\'})', 'style': $$_style,}));  ;$$_style='';if(size==0){;$$_style+='display:none;';};$$_style+='width:'+$n(size)+'px;height:'+$n(size)+'px;cursor:';if(r<=22.5||r>337.5||(r>157.5&&r<=202.5)){;$$_style+='nwse';}else if(r<=67.5||(r>202.5&&r<=247.5)){;$$_style+='ns';}else if(r<=112.5||(r>247.5&&r<=292.5)){;$$_style+='nesw';}else if(r<=157.5||(r>292.5&&r<=337.5)){;$$_style+='ew';};$$_style+='-resize;';$vnode_4.push($_create('div',{'class': 'pg pay', 'title': $n(i18n('_V')), 'mx-mousedown': $_viewId+'__bc({key:\'rb\'})', 'style': $$_style,})); $vnode_3.push(...$vnode_4); }$vnode_2.push(...$vnode_3); }$vnode_1.push(...$vnode_2); };$$_style='left:'+$n(props.x)+'px;top:'+$n(props.y)+'px;width:'+$n(props.width)+'px;height:'+$n(props.height)+'px;';if(r){;$$_style+='transform:rotate('+$n(r)+'deg);';}$$_class='pg pk';if(!fullscreen){;$$_class+=' pat';};if(selected&&!fullscreen){;$$_class+=' ';if(props.locked){;$$_class+='pav';}else{;$$_class+='pau';};};$vnode_0.push($_create('div',{'id': 'mask_'+$n(element.id), 'style': $$_style, 'class': $$_class,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    mixins: [index_1.default],
    ctor(data) {
        this.assign(data);
    ...
    '__b_<mousedown>'(e) {
        ...
        let pos = converter_1.default["__aI"]({
            x: e.pageX,
            y: e.pageY
        });
    ...
    '__bc<mousedown>'(e) {
        ...
        let transformedRect = transform_1.default["__aB"](props, rotate);
        // 获取当前点和对角线点
        let pointAndOpposite = transform_1.default["__ba"](transformedRect.point, key);
        ...
        me['__x'](e, evt => {
            ...
            let newRect = transform_1.default["__bb"](oPoint, scale, transformedRect, baseIndex);
...
/*
    ...
    loader: cmd_es
 */
define("elements/index",["magix","./line/designer","./rect/designer","./circle/designer","./text/designer","./image/designer","./repeat/designer","./page/designer","./chart-line/designer","./chart-meter/designer","./chart-bar/designer","./chart-pie/designer"],(require,exports,module)=>{
/*magix_1,designer_1,designer_2,designer_3,designer_4,designer_5,designer_6,designer_7,designer_8,designer_9,designer_10,designer_11*/

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const magix_1 = require("magix");
const designer_1 = require("./line/designer");
const designer_2 = require("./rect/designer");
const designer_3 = require("./circle/designer");
const designer_4 = require("./text/designer");
const designer_5 = require("./image/designer");
const designer_6 = require("./repeat/designer");
const designer_7 = require("./page/designer");
const designer_8 = require("./chart-line/designer");
const designer_9 = require("./chart-meter/designer");
const designer_10 = require("./chart-bar/designer");
const designer_11 = require("./chart-pie/designer");
...
let Groups = [designer_1.default, designer_2.default, designer_3.default, designer_4.default, designer_5.default, designer_6.default, { spliter: true }, {
        icon: '&#xe629;',
        title: '图表',
        subs: [designer_8.default, designer_9.default, designer_10.default, designer_11.default]
    }];
exports.default = {
    '__F'() {
        return Groups;
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-bar/designer",["../../designer/props","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,converter_1,designer_1*/
...
exports.default = designer_1.default.extend({
    ...
    props: [{
            ...
            key: 'x',
            read: converter_1.default["__aW"],
            write: converter_1.default["__aX"]
        }, {
            tip: '__z',
            type: props_1.default["__Z"],
            key: 'y',
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-bar/index",["magix"],(require,exports,module)=>{
/*magix_1*/
...
let $_temp,$vnode_0=[],$_empty_arr=[],
{
	...
	id,}=$$,
$$_style; 
 ;$$_style='position:absolute;left:'+$n(props.x)+'px;top:'+$n(props.y)+'px;height:'+$n(props.height)+'px;opacity:'+$n(props.alpha)+';width:'+$n(props.width)+'px;transform:rotate('+$n(props.rotate)+'deg);';if(props.background){;$$_style+='background:'+$n(props.background)+';';};$vnode_0.push($_create('div',{'id': 'chart_'+$n(id), 'style': $$_style,}));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
    ...
    render() {
        ...
        if (!this['__aY']) {
            this['__aY'] = echarts.init(magix_1.node('chart_' + this.id));
            this.on('destroy', () => {
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-line/designer",["../../designer/props","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,converter_1,designer_1*/
...
exports.default = designer_1.default.extend({
    ctor() {
        this.set({
            view: 'elements/chart-line/index'
        });
    }
}, {
    type: 'chart-line',
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-line/index",["magix"],(require,exports,module)=>{
/*magix_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-meter/designer",["../../designer/props","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,converter_1,designer_1*/
...
exports.default = designer_1.default.extend({
    ctor() {
        this.set({
            view: 'elements/chart-meter/index'
        });
    }
}, {
    type: 'chart-meter',
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-meter/index",["magix"],(require,exports,module)=>{
/*magix_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-pie/designer",["../../designer/props","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,converter_1,designer_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/chart-pie/index",["magix"],(require,exports,module)=>{
/*magix_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/circle/designer",["../../designer/props","../../i18n/index","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,index_1,converter_1,designer_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/circle/index",["magix"],(require,exports,module)=>{
/*magix_1*/
...
let $_temp,$vnode_0=[],$_empty_arr=[],
{
	props,}=$$,
$$_style; 
 ;$$_style='position:absolute;border-radius:50%;left:'+$n(props.x)+'px;top:'+$n(props.y)+'px;';if(props.borderwidth){;$$_style+='border:'+$n(props.borderwidth)+'px '+$n(props.bordertype)+' '+$n(props.bordercolor)+';';};if(props.fillcolor){;$$_style+='background:'+$n(props.fillcolor)+';';};$$_style+='height:'+$n(props.height)+'px;opacity:'+$n(props.alpha)+';width:'+$n(props.width)+'px;transform:rotate('+$n(props.rotate)+'deg);';$vnode_0.push($_create('div',{'style': $$_style,}));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
...
/*
    ...
    loader: cmd_es
 */
define("elements/image/designer",["../../designer/props","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,converter_1,designer_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/image/index",["magix"],(require,exports,module)=>{
/*magix_1*/
let $_quick_static_node_0;
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
$vnode_3,
$text; 
 $vnode_1=[]; if(props.image){  ;$vnode_2=[$_create('img',{'style': 'width:100%;height:100%', 'src': $n(props.image),},0,1)]; $vnode_1.push(...$vnode_2); }else{  if ($_quick_static_node_0) {
                                $vnode_2=[$_quick_static_node_0]; }else{$vnode_3=[$_create(0,0,'请选择图片')];;$vnode_2=[$_quick_static_node_0=$_create('div',{'mxs': 'pq:_', 'style': 'display:flex;align-items:center;justify-content:center;height:100%',},$vnode_3 )]; }$vnode_1.push(...$vnode_2); };$vnode_0.push($_create('div',{'style': 'position:absolute;left:'+$n(props.x)+'px;top:'+$n(props.y)+'px;height:'+$n(props.height)+'px;opacity:'+$n(props.alpha)+';width:'+$n(props.width)+'px;transform:rotate('+$n(props.rotate)+'deg);',},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
...
/*
    ...
    loader: cmd_es
 */
define("elements/line/designer",["../../designer/props","../../i18n/index","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,index_1,converter_1,designer_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/line/index",["magix"],(require,exports,module)=>{
/*magix_1*/
...
{
	props,}=$$; 
 ;$vnode_0.push($_create('div',{'style': 'position:absolute;left:'+$n(props.x)+'px;top:'+$n(props.y)+'px;border-top:'+$n(props.height)+'px '+$n(props.linetype)+' '+$n(props.color)+';opacity:'+$n(props.alpha)+';width:'+$n(props.width)+'px;transform:rotate('+$n(props.rotate)+'deg);',}));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
...
/*
    ...
    loader: cmd_es
 */
define("elements/page/designer",["../../designer/props","../../i18n/index","../../designer/const"],(require,exports,module)=>{
/*props_1,index_1,const_1*/
...
const props_1 = require("../../designer/props");
const index_1 = require("../../i18n/index");
const const_1 = require("../../designer/const");
exports.default = {
    title: '__ac',
    getProps() {
        return {
            width: const_1.default["__D"],
            height: const_1.default["__E"],
            background: '#ffffff',
            backgroundImage: '',
    ...
    props: [{
            ...
            type: props_1.default["__ag"],
            items: [{
                    text: index_1.default('__ae'),
                    value: 'auto'
                }, {
                    text: index_1.default('__af'),
                    value: 'full'
                }]
        }, {
            type: props_1.default["__aa"]
            ...
            type: props_1.default["__ag"],
            items: [{
                    text: index_1.default('__ai'),
                    value: 'full'
                }, {
                    text: index_1.default('__aj'),
                    value: 'no-repeat'
                }, {
                    text: index_1.default('__ak'),
                    value: 'repeat-x'
                }, {
                    text: index_1.default('__al'),
                    value: 'repeat-y'
                }, {
                    text: index_1.default('__am'),
                    value: 'repeat'
                }],
            refresh: true,
            ifShow(page) {
...
/*
    ...
    loader: cmd_es
 */
define("elements/rect/designer",["../../designer/props","../../i18n/index","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,index_1,converter_1,designer_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/rect/index",["magix"],(require,exports,module)=>{
/*magix_1*/
...
let $_temp,$vnode_0=[],$_empty_arr=[],
{
	props,}=$$,
$$_style; 
 ;$$_style='position:absolute;left:'+$n(props.x)+'px;top:'+$n(props.y)+'px;';if(props.borderwidth){;$$_style+='border:'+$n(props.borderwidth)+'px '+$n(props.bordertype)+' '+$n(props.bordercolor)+';';};if(props.fillcolor){;$$_style+='background:'+$n(props.fillcolor)+';';};$$_style+='height:'+$n(props.height)+'px;opacity:'+$n(props.alpha)+';width:'+$n(props.width)+'px;transform:rotate('+$n(props.rotate)+'deg);';if(props.radius){;$$_style+='border-radius:'+$n(props.radius)+'px;';};$vnode_0.push($_create('div',{'style': $$_style,}));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
...
/*
    ...
    loader: cmd_es
 */
define("elements/repeat/designer",["../../designer/props","../../i18n/index","../../util/converter","../designer"],(require,exports,module)=>{
/*props_1,index_1,converter_1,designer_1*/
...
/*
    ...
    loader: cmd_es
 */
define("elements/repeat/index",["magix"],(require,exports,module)=>{
/*magix_1*/
let $_quick_static_node_0;
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
$vnode_3,
$text; 
 $vnode_1=[]; if(!props.image){  if ($_quick_static_node_0) {
                                $vnode_2=[$_quick_static_node_0]; }else{$vnode_3=[$_create(0,0,'请选择平铺图片')];;$vnode_2=[$_quick_static_node_0=$_create('div',{'mxs': 'pt:_', 'style': 'display:flex;align-items:center;justify-content:center;height:100%',},$vnode_3 )]; }$vnode_1.push(...$vnode_2); };$$_style='position:absolute;left:'+$n(props.x)+'px;top:'+$n(props.y)+'px;height:'+$n(props.height)+'px;opacity:'+$n(props.alpha)+';width:'+$n(props.width)+'px;transform:rotate('+$n(props.rotate)+'deg);';if(props.radius){;$$_style+='border-radius:'+$n(props.radius)+'px;';};if(props.image){;$$_style+='background-image:url('+$n(props.image)+');background-size:'+$n(props.imageWidth)+'px '+$n(props.imageHeight)+'px;background-repeat:'+$n(props.repeat)+';';};$vnode_0.push($_create('div',{'style': $$_style,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init(data) {
        this.assign(data);
    },
...
let $_temp,$vnode_0=[],$_empty_arr=[]; 
 if ($_quick_static_node_0) {
                                ...
                                $vnode_0.push($_quick_static_node_1); }else{;$vnode_0.push($_quick_static_node_1=$_create('div',{'mxs': 'pb:a', 'mx-view': 'designer/toolbar', 'class': 'paf pk',})); } if ($_quick_static_node_2) {
                                $vnode_0.push($_quick_static_node_2); }else{;$vnode_0.push($_quick_static_node_2=$_create('div',{'mxs': 'pb:b', 'mx-view': 'designer/axis?scroll=stage', 'class': 'pk ph',})); } if ($_quick_static_node_3) {
                                $vnode_0.push($_quick_static_node_3); }else{;$vnode_0.push($_quick_static_node_3=$_create('div',{'mxs': 'pb:c', 'mx-view': 'designer/stage', 'id': 'stage', 'class': 'pag pl pah',})); } 
return $_create($_viewId, 0, $vnode_0);  } ,
    mixins: [index_2.default],
    init() {
...
Service.add([{
        name: '__aj',
        url: magix_1.default.config('getImageUrl'),
        cache: 30 * 60 * 1000
    }]);
exports.default = {
    ctor() {
    ...
    '__at'(xy) {
        ...
        if (list) {
            ...
            for (let m of list) {
                ...
                selected.push(nm);
                if (me['__ap']) {
                    stage_elements_1.default["__ar"](m.id, true);
                }
            }
            if (me['__ap']) {
                delete me['__ap'];
            ...
            stage_select_1.default['__as'](selected);
        }
        return update;
    }
};
...
exports.default = {
    '__L'(e, focus) {
        ...
        if (ctrl) {
            ...
            elements.push(em);
            if (focus) {
                stage_select_1.default["__au"](em);
            }
            return elements;
        }
    },
        ...
        if (e.shiftKey || e.ctrlKey || e.metaKey) {
            if (!element.props.locked) {
                ...
                if (exists && elements.length > 1) {
                    if (stage_select_1.default["__av"](element)) {
                        history_1.default["__t"]();
                    }
                    return;
                }
                if (stage_select_1.default['__aw'](element)) {
                    history_1.default["__t"]();
                }
            }
        }
    ...
    '__az'(event, view) {
        ...
        if (event.shiftKey || event.ctrlKey || event.metaKey) { //多选
            this["__ax"](event, element);
        }
        else {
            cursor_1.default["__ay"]('move');
    ...
    '__aC'() {
        ...
        for (let e of elements) {
            ...
            let tsed = transform_1.default["__aB"](rect, rotate);
            let lt = tsed.point[0];
            let rt = tsed.point[2];
            let lb = tsed.point[6];
            let rb = tsed.point[4];
    ...
    '__aD'(elementLocations, rect, bak) {
    ...
    '__aF'() {
        ...
        stage_select_1.default["__as"](added);
        if (stage_select_1.default["__aE"](last)) {
            history_1.default["__t"]();
        }
    },
    '__aG'(to, element) {
    ...
    '__aH'(e) {
        ...
        if (c === 0 || c > 1) {
            ...
            stage_select_1.default["__au"](current);
        }
        else {
            let prev, next;
            for (let i = stageElements.length; i--;) {
            ...
            if (select.id != current.id) {
                stage_select_1.default["__au"](select);
            }
        }
    }
};
...
return $_create($_viewId, 0, $vnode_0);  } ,
    ...
    init() {
        let addElements = e => {
            if (e.node) {
                if (magix_1.default.inside(e.node, magix_1.node('stage_outer'))) {
                    let p = converter_1.default["__aI"]({
                        x: e.pageX,
                        y: e.pageY
                    });
                    e.pageX = p.x;
        ...
        magix_1.State.on('__c', (e) => {
            if (magix_1.default.inside(e.node, magix_1.node('stage_outer'))) {
                select_1.default["__aJ"](e.pageX, e.pageY, e.width, e.height);
            }
            else {
                select_1.default["__z"]();
            }
    ...
    '__aK<mousedown>'(e) {
        ...
        if (fs)
            return;
        stage_elements_1.default["__az"](e, this);
    },
    '__aM<mousedown>'(e) {
        let fs = this.get('fullscreen');
        if (fs)
        ...
        if (target.id == 'stage_canvas' ||
            ...
            select_1.default["__H"]();
            let showedCursor = 0;
            let elementLocations = stage_elements_1.default["__aC"]();
            this['__x'](e, ex => {
                if (!showedCursor) {
                    showedCursor = 1;
                    cursor_1.default["__ay"]('default');
                }
                ...
                select_1.default["__aJ"](left, top, width, height);
                let rect = converter_1.default["__aI"]({
                    x: left,
                    y: top
                });
                rect.width = width;
                ...
                if (elementLocations.length) {
                    let intersectElements = stage_elements_1.default["__aD"](elementLocations, rect, bak);
                    let count = intersectElements.length;
                    if (count !== this['__aL']) {
                        this['__aL'] = count;
                        stage_select_1.default["__as"](intersectElements);
                    }
                }
            }, () => {
                if (showedCursor) {
    ...
    '__aN<keydown>'(e) {
        ...
        if (e.metaKey || e.ctrlKey) {
            if (e.keyCode == keys_1.default.Z) {
                ...
                e.preventDefault();
                stage_elements_1.default["__aF"]();
            }
            else if (e.keyCode == keys_1.default.X) {
                e.preventDefault();
                stage_clipboard_1.default["__aq"]();
            }
                ...
                e.preventDefault();
                stage_clipboard_1.default["__at"]();
            }
        }
        else {
            if (e.keyCode == keys_1.default.TAB) {
                e.preventDefault();
                stage_elements_1.default["__aH"](e);
            }
            else if (e.keyCode == keys_1.default.DELETE) {
                e.preventDefault();
                if (stage_elements_1.default["__aA"]()) {
                    magix_1.State.fire('__i');
                    history_1.default["__t"]();
                }
            }
    ...
    '__B<contextmenu>'(e) {
        ...
        if (magix_1.default.inside(e.target, magix_1.node('stage_canvas'))) {
            ...
            let stageElements = magix_1.State.get('__N');
            let selectElements = magix_1.State.get('__O');
            let hasElements = stage_clipboard_1.default["__am"]();
            ...
            index_2.default.show(this, e, {
                ...
                picked(menu) {
                    if (menu.id == contextmenu_1.default.allId) {
                        ...
                        if (stage_clipboard_1.default["__at"](p)) {
                            history_1.default["__t"]();
                        }
                    }
                        ...
                        if (stage_elements_1.default["__aG"](menu.id, element)) {
                            magix_1.State.fire('__i');
                            history_1.default["__t"]();
                        }
                    }
...
$vnode_1; 
let c=elements.length;; if ($_quick_static_node_0) {
                                $vnode_0.push($_quick_static_node_0); }else{;$vnode_0.push($_quick_static_node_0=$_create('i',{'mxs': 'pe:_', 'class': 'pap',})); } $vnode_1=[$_create(0,0,'')];;$$_class='px pan';if(c<1){;$$_class+=' paq';};$vnode_0.push($_create('i',{'title': $n(i18n('__j'))+'(Delete)', 'mx-click': $_viewId+'__aR()', 'class': $$_class,},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init() {
        let update = this.render.bind(this);
        magix_1.State.on('___', update);
...
return $_create($_viewId, 0, $vnode_0);  } ,
    ...
    '__aG<click>'(e) {
        ...
        if (stage_elements_1.default["__aG"](to, element)) {
            magix_1.State.fire('__i');
            history_1.default["__t"]();
        }
    }
...
$vnode_2,
$text; 
for(let $q_key_rlrpbsmtmb=0,$q_a_gpvzicweyv=panels,$q_c_xobuwfoj=$q_a_gpvzicweyv.length;$q_key_rlrpbsmtmb<$q_c_xobuwfoj;$q_key_rlrpbsmtmb++){let p=$q_a_gpvzicweyv[$q_key_rlrpbsmtmb];  $vnode_2=[$_create(0,1,(p.icon))];;$$_class='px pan';if(p.opened){;$$_class+=' pao';};$vnode_1=[$_create('i',{'mx-click': $_viewId+'__aU({id:\''+($eq(p.id))+'\'})', 'title': $n(i18n(p.opened?'_t':'_u',p.title)), 'class': $$_class,},$vnode_2 )]; $vnode_0.push(...$vnode_1); } 
return $_create($_viewId, 0, $vnode_0);  } ,
    init() {
    ...
    render() {
        this.digest({
            panels: index_1.default["__aT"]()
        });
    },
    '__aU<click>'(e) {
        let { id } = e.params;
        index_1.default["__aU"](id);
    }
});
...
$vnode_1,
$text; 
 $vnode_1=[$_create(0,0,'')];;$vnode_0.push($_create('i',{'class': 'px pan', 'mx-click': $_viewId+'__aV({s:\'-\'})', 'title': $n(i18n('_v')),},$vnode_1 ));  $vnode_1=[$_create(0,0,(scale*100)+'%')];;$vnode_0.push($_create('b',$_quick_vnode_attr_static_0,$vnode_1 ));  $vnode_1=[$_create(0,0,'')];;$vnode_0.push($_create('i',{'class': 'px pan', 'mx-click': $_viewId+'__aV({s:\'+\'})', 'title': $n(i18n('_w')),},$vnode_1 ));  
return $_create($_viewId, 0, $vnode_0);  } ,
    init() {
        let update = this.render.bind(this);
        magix_1.State.on('__a', update);
